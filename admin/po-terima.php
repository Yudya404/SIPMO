...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='keyword' placeholder='Cari ID Pemesanan/Nama Makanan/Status Makanan' required /> 
           ...
           <!-- /.row -->
					...
					$sql     =  "SELECT * FROM po_terima WHERE status_makanan LIKE '%$keyword%' or nopo like '%$keyword%' or nama like '%$keyword%' ";
                  ...
                  <thead>
                      <tr>
						...
						<th><center>Status Makanan</center></th>
                    ...
                    <td><span class="glyphicon glyphicon-cutlery"></span> <?php echo $data['nama'];?></td>
