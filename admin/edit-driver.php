    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
				$id_driver = $_GET['id'];
				$sql = mysqli_query($koneksi, "SELECT * FROM driver WHERE id_driver='$id_driver'");
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Data Driver </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-driver.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode</label>
                              <div class="col-sm-8">
                                  <input name="id_driver" type="text" id="id_driver" value="<?php echo $row['id_driver']; ?>" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" value="<?php echo $row['nama']; ?>" class="form-control" autocomplete="off" placeholder="Nama Driver" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="alamat" type="text" id="alamat" value="<?php echo $row['alamat']; ?>" class="form-control" autocomplete="off" placeholder="Alamat Driver" autocomplete="off" required />
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nopol" type="text" id="nopol" value="<?php echo $row['nopol']; ?>" class="form-control" autocomplete="off" placeholder="Nopol Kendaraan Driver" autocomplete="off" required />
