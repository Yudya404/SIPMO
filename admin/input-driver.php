            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Input Driver</li>
                    </ol>
                </section>
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	$jenis_gambar=$_FILES['nama_file']['type'];
        ...
        $cekno= mysqli_query($koneksi, "SELECT * FROM driver ORDER BY id_driver DESC");
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO driver(id_driver,nama,alamat,no_telp,nopol,username,password,gambar) VALUES
            ('$id_driver','$nama','$alamat','$no_telp','$nopol','$username','$password','$gambar')";
			$res=mysqli_query($koneksi, $sql) or die (mysqli_error());
			//echo "Gambar berhasil dikirim ke direktori".$gambar;
            echo "<script>alert('Data Driver berhasil dimasukan!'); window.location = 'driver.php'</script>";	   
		} else {
	...
	echo "Anda belum memilih gambar";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Input Data Driver </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-driver.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode</label>
                              <div class="col-sm-8">
                                  <input name="id_driver" type="text" id="id_driver" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" class="form-control" autocomplete="off" placeholder="Nama Driver" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="alamat" type="text" id="alamat" class="form-control" autocomplete="off" placeholder="Alamat Driver" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="no_telp" type="text" id="no_telp" class="form-control" autocomplete="off" placeholder="No Telepon Driver" autocomplete="off" required />
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nopol" type="text" id="nopol" class="form-control" autocomplete="off" placeholder="Nopol Kendaraan Driver" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="driver.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
								<div class="text-right">
								<a href="driver.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
								</div>
                          </div>
                      </form>
                  </div>
