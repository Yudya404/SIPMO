        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Data Pesanan Masuk (Invoice)</li>
                    </ol>
                </section>
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Data Pesanan Masuk (Invoice)</h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-po-terima.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
						  ...
						  <div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label">Status Makanan</label>
									<div class="col-sm-3">
										<select id="status_makanan" name="status_makanan" class="form-control" required>
											...
											<option value="Proses">Proses Masak</option>
											<option value="Otw">Otw Kirim</option>
                            ...
                            <div class="col-sm-3">
                            <?php
                            if($row['status_makanan'] == 'Selesai'){
								echo '<span class="label label-success">Pesanan Selesai</span>';
							}
                            else if ($row['status_makanan'] == 'Otw' ){
								echo '<span class="label label-warning">Pesanan Sedang Dikirim</span>';
							}
							else if ($row['status_makanan'] == 'Proses' ){
								echo '<span class="label label-warning">Pesanan Proses Dimasak</span>';
							}
							else if ($row['status_makanan'] == 'Belum' ){
								echo '<span class="label label-danger">Pesanan Belum Diproses</span>';
							}
							?>
                            </span>
                            </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
								...
								<a href="po-terima.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
								</div>
                          </div>
                      </form>
                  </div>
