...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
			...
			?>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Konfirmasi Pembayaran</a></li>
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='keyword' placeholder='Cari No Po/Tanggal/Status Pembayaran' required /> 
           ...
           <!-- /.row -->
					...
					$sql     =  "SELECT * FROM konfirmasi WHERE status LIKE '%$keyword%' or nopo like '%$keyword%' or tanggal like '%$keyword%' ";
					$result  = mysqli_query($koneksi, $sql);
					}else{
					#jika tidak ada pencarian pakai ini
					$reload = "?pagination=true";
					$sql =  "SELECT * FROM konfirmasi order by id_kon DESC";
					$result = mysqli_query($koneksi, $sql);
					}
                  ...
                  <thead>
                    ...
                    <td><center><a href="detail-customer.php?hal=edit&kd=<?php echo $data['kd_cus'];?>"><?php echo $data['nopo'];?></center></td>
