...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='keyword' placeholder='Cari Data Nama/Username' required /> 
           ...
           <!-- /.row -->
					...
					<div class="text-right">
						<a href="input-customer.php" class="btn btn-sm btn-success">Tambah Customer <i class="fa fa-arrow-circle-right"></i></a>
					</div>
					<br />
					...
					$sql     =  "SELECT * FROM customer WHERE nama LIKE '%$keyword%' or username like '%$keyword%'";
					$result  = mysqli_query($koneksi, $sql);
					}else{
					#jika tidak ada pencarian pakai ini
					$reload = "?pagination=true";
					$sql =  "SELECT * FROM customer order by kd_cus DESC";
					$result = mysqli_query($koneksi, $sql);
					}
