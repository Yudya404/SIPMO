...
$result=mysqli_query($koneksi, "SELECT po_terima.*, konfirmasi.jumlah, produk.kode AS kode_prod, produk.nama, produk.harga, customer.alamat, customer.no_telp, customer.nama AS nama_cus, po_terima.status_makanan FROM po_terima
...
$pdf->Image('../img/logo4.png',10,10,-175);
//$pdf->Image('../images/BBRI.png',190,10,-200);
$pdf->SetFont('Arial','B',13);
$pdf->Cell(80);
$pdf->Cell(30,10,'Nota Pembayaran',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'Warung Bebek Srundeng',0,0,'C');
$pdf->Ln();
...
$pdf->SetY($Y_Fields_Name_position);
$pdf->SetX(5);
$pdf->Cell(40,8,'Pelanggan : '.$nama_cus,0,0,'L',1);
$pdf->SetX(45);
$pdf->Cell(40,8,'',0,0,'L',1);
$pdf->SetX(85);
$pdf->Cell(50,8,'',0,0,'C',1);
...
$pdf->SetX(65);
$pdf->Cell(40,8,'Item',1,0,'C',1);
$pdf->SetX(105);
$pdf->Cell(60,8,'Harga',1,0,'C',1);
//$pdf->SetX(165);
...
$pdf->SetX(5);
$pdf->MultiCell(40,8,$nopo,1,'C');*/

$pdf->SetY($Y_Table_Position);
$pdf->SetX(5);
$pdf->MultiCell(60,8,$nama,1,'L');

$pdf->SetY($Y_Table_Position);
$pdf->SetX(65);
$pdf->MultiCell(40,8,$qty,1,'C');

$pdf->SetY($Y_Table_Position);
$pdf->SetX(105);
$pdf->MultiCell(60,8,$rupiah.$harga.'',1,'C');
...
$pdf->SetX(5);
$pdf->Cell(60,8,'Total Tagihan',1,0,'C',1);
$pdf->SetX(65);
$pdf->Cell(100,8,$rupiah.$total.'',1,0,'R',1);
$pdf->Ln();
$pdf->SetFillColor(110,180,230);
$pdf->Ln(10);
