 ...
 <?php
             if(isset($_GET['aksi']) == 'delete'){
				...
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item tidak ditemukan.</div>';
				}else{
					...
					if($delete){
						...
						echo '<div class="alert alert-primary alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item berhasil dihapus.</div>';
					}else{
						echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item gagal dihapus.</div>';
					}
				}
			}
			?>
             ...
             if(isset($_GET['add']) == 'add'){
                ...
                if(mysqli_num_rows($cek1) == 0){
					...
					if($add){
						...
						echo '<div class="alert alert-primary alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item Produk berhasil ditambah</div>';
					}else{
						echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item produk gagal ditambah !</div>';
					}
				}
			}
			?>
             ...
             if(isset($_GET['less']) == 'less'){
                ...
                if(mysqli_num_rows($cek2) == 0){
					...
					if($less){
						...
						echo '<div class="alert alert-primary alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item Produk berhasil dikurangi.</div>';
					}else{
						echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Item Produk gagal dikurangi !</div>';
					}
				}
			}
			?>
...
<tr>
    ...
    //mysql_select_db($database_conn, $conn);
            ...
            ?>
                ...
                <td><center><a href="detail.php?add=add&kd1=<?php echo $data['kode']; ?>" class="btn btn-xs btn-success">Tambah</a> <a href="detail.php?less=less&kd2=<?php echo $data['kode']; ?>" class="btn btn-xs btn-warning">Kurangi</a> <a href="detail.php?aksi=delete&kd=<?php echo $data['kode']; ?>" class="btn btn-xs btn-danger">Hapus</a></center></td>
                </tr>
				...
				if($total == 0){
					...
					echo '<p><div align="right">
						<a href="index.php" class="btn btn-primary btn-lg">&laquo; Tambah Menu</a>
						</div></p>';
				} else {
					echo '
						...
						<p><div align="right">
						<a href="index.php" class="btn">&laquo; Tambah Menu Lain</a>
