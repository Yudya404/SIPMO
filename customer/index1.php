            ...
            <aside class="right-side">
              ...
              ?>
                  ...
                  <!-- </div>
                        ...
                        <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-tag"></span> Riwayat Pesanan </h3> 
                        </div>
                        <div class="panel-body">
                       <!-- <div class="table-responsive"> -->
                    <?php
                  ...
                  <thead>
					...
					<td><center><?php echo convertDateTimeDBtoIndo($data2['tanggal']);?></center></td>
              ...
              ?>
                  ...
                  <!-- </div>-->
                    ...
                    <?php
                    $kd = $_SESSION['user_id'];
                    $query3="select * from konfirmasi where kd_cus='$kd' order by id_kon DESC Limit 5";
                    $hasil2=mysqli_query($koneksi, $query3) or die(mysqli_error());
                    ?>
                  <table id="example" class="table table-hover table-bordered">
                  <thead>
