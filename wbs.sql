...
--
-- Host: 127.0.0.1
-- Generation Time: 08 Okt 2020 pada 18.24
...
(23, '20200710122913', '20200710122913', 'Cash On Delivery (COD)', '2020-07-10 13:10:19', 15000, '0', 'Bayar'),
(24, '20200710122913', '20200710122913', 'Cash On Delivery (COD)', '2020-07-10 14:08:24', 54000, '0', 'Bayar'),
(25, '20200710122913', '20200710122913', 'Cash On Delivery (COD)', '2020-07-10 14:19:17', 40000, '0', 'Bayar'),
(26, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-10 15:20:24', 12000, '0', 'Bayar'),
(27, '20200710122913', '20200710122913', 'Cash On Delivery (COD)', '2020-07-10 15:30:56', 8000, '0', 'Bayar'),
(28, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-13 08:47:38', 13500, '0', 'Bayar'),
(29, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-13 10:27:39', 15000, '0', 'Bayar'),
(30, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-13 10:37:38', 3000, '0', 'Bayar'),
(31, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-13 13:01:34', 3500, '0', 'Bayar'),
(32, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-14 12:41:35', 6500, '0', 'Bayar'),
(33, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-15 09:29:29', 10000, '0', 'Bayar'),
(34, '20200710151929', '20200710151929', 'Cash On Delivery (COD)', '2020-07-16 08:37:36', 15000, '0', 'Bayar');
...
CREATE TABLE `po_terima` (
  ...
  `status_makanan` enum('Belum Diproses','Proses Masak','Otw Kirim','Selesai') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(56, 'Bakmi Ambyar', 'Makanan', 10000, 'Bakmi Dengan Topping Ayam + Pentol + Telur + Sawi Putih + Acar + Cabe', 10, 'gambar_produk/Bakmi.jpg'),
...
(62, 'Es Kopi', 'Minuman', 3500, 'Es Kopi', 13, 'gambar_produk/EsKopi.jpg'),
(63, 'Pentol Crispy ', 'Camilan', 10000, 'Pentol Crispy 1 porsi Isi 4 Tusuk,  1 Tusuk Isi 3 Biji (1 Porsi Isi 12 Biji) + Sambal Pedas', 14, 'gambar_produk/PentolC.jpg');
...
(6, 'yudya', '7c222fb2927d828af22f592134e8932480637c0d', 'Yudya Sukma', 'gambar_admin/logo1.jpg');
...
--
ALTER TABLE `konfirmasi`
  MODIFY `id_kon` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
