...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Halaman Driver | Warung Bebek Srundeng</title>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="detail-konfirmasi.php?hal=edit&kd=<?php echo $_SESSION['id_driver'];?>" class="btn btn-default btn-flat">Profil</a>
                                    </div>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
			...
			?>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Konfirmasi Pembayaran</li>
                    </ol>
                </section>
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Data Konfirmasi Pembayaran</h3> 
                        </div>
                        <?php
