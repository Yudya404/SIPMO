                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-customer.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="no_telp" type="text" id="no_telp" value="<?php echo $row['no_telp']; ?>" class="form-control" autocomplete="off" placeholder="No Telepon Diver" autocomplete="off" required />
                              
                            </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nopol Kendaraan Driver</label>
                              <div class="col-sm-3">
                            <input name="nopol" type="text" id="nopol" value="<?php echo $row['nopol']; ?>" class="form-control" autocomplete="off" placeholder="Nopol Kendaraan Diver" autocomplete="off" required />
