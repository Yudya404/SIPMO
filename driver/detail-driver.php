        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM driver WHERE id_driver='$_GET[id]'");
                    ...
                    <!--<tr>
                    <td>Kode</td>
                    <td><?php echo $data['id_driver']; ?>
					</td>-->
					<tr>
                    <td rowspan="9"><div class="pull-right image">
                            <img src="<?php echo $data['gambar']; ?>" class="img-rounded" height="300" width="250" alt="User Image" style="border: 1px solid #333333;" />
                        </div></td>
                    </tr>
                    <tr>
